...
namespace AutoTable.Data.Entities
{
    ...
    /// <summary>
    /// Invite code generated by an administrator for data entrants.
    /// The code grants access to the sign-up page and carries the
    /// role + permission scope the admin configured when generating it.
    /// </summary>
    public class InviteCodeEntity
    {
        public int Id { get; set; }

        /// <summary>The unique code string (e.g. "AB12-CD34").</summary>
        public string Code { get; set; } = string.Empty;

        /// <summary>Role the invite grants (e.g. "DataEntrant").</summary>
        public string Role { get; set; } = "DataEntrant";

        /// <summary>Optional label the admin attaches (e.g. "Term 2 marks entry").</summary>
        public string? Label { get; set; }

        /// <summary>Comma-separated page tags the entrant may access
        /// (e.g. "MarksEntry,Gradebook"). Empty means all pages.</summary>
        public string? AllowedPages { get; set; }

        /// <summary>True once someone has used this code to register.</summary>
        public bool IsUsed { get; set; }

        /// <summary>UserId of the admin who generated the code.</summary>
